...
SOURCE_RELIABILITY_ADR = "../resources//compiledReliabilityDict.txt"
LINGUISTIC_FEATURES_ADR = "../resources//dataFiles//lingFeatures//out/"
            ...
            if articleCount > 2:
                for article in claimData[1]:
                    ...
                    if doit == True:
                        ...
                        #get ling feats
                        with open(LINGUISTIC_FEATURES_ADR+file_ , 'r') as lFile:
...
def getJointSocialDataSet():
    ...
    #reliability data
    with open(SOURCE_RELIABILITY_ADR, "r") as relFile:
...
def getJointLongTailDataSet(numArticles):
    ...
    for file_ in os.listdir("../resources//contentTrain//out"):
        if file_.endswith(".json"):
            ...
            if len(claimData[1]) >= numArticles:
                if len(claimData[0]) > 0:
                    fullClaimData[0]= (claimData[0])[0]#truth value
                    fullClaimData[2] = file_
