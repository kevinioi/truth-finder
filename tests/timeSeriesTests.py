...
def sumStrenthOverTime():
    ...
    for claim in fullData:
        for day in claim[0]:
            for article in claim[0][day]:#for each article append the reliability corrected stance probabilites
                strengths[claim[1]][int(day)].append((article[0][2]*article[0][1],article[0][3] * article[0][1]))
